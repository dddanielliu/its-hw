#
# OMNeT++/OMNEST Makefile for homework
#
# This file was generated with the command:
#  opp_makemake -f --deep -o homework -O out -KVEINS_ROOT=/packages/veins/src/
#

# Name of target to be created (-o option)
TARGET = homework$(D)$(EXE_SUFFIX)
TARGET_DIR = .
